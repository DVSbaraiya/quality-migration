...
<div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('front/img/breadcrumb.jpg');">
    <div class="container">
        <div class="page-heading">
            <h1 class="wow fadeInUp" data-wow-delay=".3s">Visa Details</h1>
                ...
                <div class="col-lg-4 order-2 order-md-1">
                    <div class="visa-sidebar">
                        <div class="visa-widget-categories">
                            <ul>
                                <li><a href="{{ route('servicedetails') }}">Student Visa<span><i class="fas fa-chevron-right"></i></span></a></li>
                                <li><a href="{{ route('servicedetails') }}">Family Visa<span><i class="fas fa-chevron-right"></i></span></a></li>
                                <li><a href="{{ route('servicedetails') }}">Tourist Visa<span><i class="fas fa-chevron-right"></i></span></a></li>
                                <li><a href="{{ route('servicedetails') }}">Business Visa<span><i class="fas fa-chevron-right"></i></span></a></li>
                                <li><a href="{{ route('servicedetails') }}">Worker Visa<span><i class="fas fa-chevron-right"></i></span></a></li>
                                <li><a href="{{ route('servicedetails') }}">Diplomatic Visa<span><i class="fas fa-chevron-right"></i></span></a></li>
                            </ul>
                        </div>
                        <div class="visa-sidebar-widget">
                            <div class="contact-bg text-center bg-cover" style="background-image: url('front/img/all-image/visa-detail/contact.jpg');">
                        ...
                        <a href="{{ route('servicedetails') }}" class="theme-btn w-100 text-center">
                            <span><i class="fas fa-file-pdf me-3"></i> download pdf file</span>
                        </a>
                    </div>
                </div>
                <div class="col-lg-8 order-1 order-md-2">
                    <div class="{{ route('servicedetails') }}-items">
                        <div class="details-image">
                            <img src="{{ asset("front/img/all-image/visa-detail/service-details.jpg") }}" alt="img">
                        </div>
                        <div class="details-content">
                            ...
                            <p class="mt-3">
                                ...
                                Fugiat labore aspernatur eius, perspiciatis ut molestiae, delectus rem.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat qui ducimus illum modi? perspiciatis
                                accusamus soluta perferendis, ad illum, nesciunt, reiciendis iusto et cupidit Repudiandae provident to
                                consectetur, sapiente, libero iure necessitatibus corporis nulla voluptate, quisquam aut perspiciatis?
                            ...
                            <p class="mt-3">
                                ...
                                accusamus soluta perferendis, ad illum, nesciunt, reiciendis iusto et cupidit Repudiandae provident to
                                consectetur, sapiente, libero iure necessitatibus corporis nulla voluptate, quisquam aut perspiciatis?
                                Fugiat labore aspernatur eius, perspiciatis ut molestiae, delectus rem.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Placeat qui ducimus illum modi.
                            </p>
                                        ...
                                        <div class="accordion-item wow fadeInUp" data-wow-delay=".3s">
                                            ...
                                            <div id="faq1" class="accordion-collapse collapse" data-bs-parent="#accordion">
                                                <div class="accordion-body">
                                                    ...
                                                    Duis aute irure dolor in reprehenderit in voluptate velit.Quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.
