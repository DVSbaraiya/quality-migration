...
<div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('front/img/breadcrumb.jpg');">
    <div class="container">
        <div class="page-heading">
            <h1 class="wow fadeInUp" data-wow-delay=".3s">Naati Deatails</h1>
                    ...
                    <div class="country-sidebar">
                        ...
                        <div class="country-sidebar-widget">
                            <div class="contact-bg bg-cover"
                                style="background-image: url('front/img/all-image/coaching-detail/world.jpg');">
                                <h3>Dream Tour</h3>
                                <h2 class="title-anim">
                                    Explore <br>
                                    The World
                ...
                <div class="col-lg-8 order-1 order-md-2">
                    <div class="coaching-details-items">
                        <div class="details-image">
                            <img src="{{ asset('front/img/all-image/coaching-detail/service-details.jpg') }}" alt="img">
                        </div>
                        <div class="details-content">
                            ...
                            <div class="row g-4 mt-3 mb-4">
                                <div class="col-lg-6">
                                    <div class="details-thumb-2">
                                        <img src="{{ asset('front/img/all-image/coaching-detail/coaching-three-1-3-1.jpg') }}" alt="img">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="details-thumb-2">
                                        <img src="{{ asset('front/img/all-image/coaching-detail/coaching-7.jpg') }}" alt="img">
                                    </div>
                                </div>
                            </div>
                            <p class="mb-3">
                            ...
                            <div class="row g-5 mt-2 align-items-center">
                                <div class="col-lg-6">
                                    <div class="thumb-2">
                                        <img src="{{ asset('front/img/all-image/coaching-detail/coaching-1-3.jpg') }}" alt="img">
                                        <div class="video-box">
