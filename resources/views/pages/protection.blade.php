    ...
    <div class="container px-4 px-md-0">
        <div class="coaching-details-wrapper">
            <div class="row g-5">
                ...
                <div class="details-content">
                    <div class="">
                        <h3 class="">Australia Protection & Humanitarian Visas</h3>
                        <!-- SHEV -->
                        <div class="row mb-5">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="section-div">
                                    <h4 class="mb-2">Safe Haven Enterprise Visa (Subclass 790)</h4>
                                    ...
                                    <ul class="list-unstyled text-start">
                                        ...
                                        <h5 class="primary-website-text my-2 pt-3">Eligibility:-</h5>
                                        <li>
                                        ...
                                        <h5 class="primary-website-text my-2 pt-3">Pathway Opportunities</h5>
                                        <li>
                        ...
                        <div class="section-div mb-5">
                            <h3 class="">Protection Visa (Subclass 866)</h3>
                            ...
                            <ul class="list-unstyled text-start">
                                ...
                                <h5 class="primary-website-text mb-2 pt-3">Pathway Opportunities</h5>
                                <li>
