            ...
            <div class="faq-wrapper">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <a href="{{ route('faq') }}" class="theme-btn mt-4 wow fadeInUp" data-wow-delay=".7s">
                ...
                <div class="row g-4">
                    <div class="col-lg-4">
                        <div class="details-image">
                                <img src="{{ asset("front/img/all-image/visa-detail/faq-search-shape-1-1.png")}}" alt="img">
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="details-image">
                                <img src="{{ asset("front/img/all-image/visa-detail/faq.jpg")}}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="brand-wrapper style-2">
                <div class="brand-carousel-active-2">
                    <div class="brand-image">
                            <img src="{{ asset("front/img/brand/01.png")}}" alt="brand-img">
                    </div>
                    <div class="brand-image">
                            <img src="{{ asset("front/img/brand/01.png")}}" alt="brand-img">
                    </div>
