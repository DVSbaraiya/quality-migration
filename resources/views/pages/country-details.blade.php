    ...
    <div class="breadcrumb-wrapper section-padding bg-cover" style="background-image: url('front/img/breadcrumb.jpg');">
        <div class="container">
            <div class="page-heading">
                <h1 class="wow fadeInUp" data-wow-delay=".3s">Country Details</h1>
                    ...
                    <div class="col-lg-8">
                        <div class="country-details-items">
                            ...
                            <div class="details-image">
                                <img src="{{ asset('front/img/country/details-1.jpg') }}" alt="img">
                            </div>
                            <p class="mb-3">
                            ...
                            <div class="row g-4 mt-4 align-items-center">
                                <div class="col-lg-6">
                                    <div class="thumb-2">
                                        <img src="{{ asset('front/img/country/details-2.jpg') }}" alt="img">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="content">
                            ...
                            <div class="row g-4 mt-5 align-items-center">
                                ...
                                <div class="col-lg-6">
                                    <div class="thumb-2">
                                        <img src="{{ asset('front/img/country/details-3.jpg') }}" alt="img">
                                        <div class="video-box">
                        ...
                        <div class="country-sidebar">
                            ...
                            <div class="country-sidebar-widget">
                                <div class="contact-bg bg-cover"
                                    style="background-image: url('front/img/service/contact-bg.jpg');">
                                    <h3>Dream Tour</h3>
                                    <h2>
                                        Explore <br>
                                        The World
